...
3. **Access the web server**:
   - **Image Gallery**: `http://localhost:8000/` - Browse all captured images
   - **Network Gallery**: `http://YOUR_IP:8000/` - Access from other devices on your network
   - **Ping Test**: `http://localhost:8000/ping` - Simple connectivity test
...
### GET / (Image Gallery)
Main interface displaying all captured images in a responsive grid layout. Users can browse thumbnails and click to view full-size images.

**Features:**
- Responsive grid layout with image thumbnails
- Shows total image count and latest capture time
- Click any image to view in full size
- Automatic sorting (newest images first)
- Mobile-friendly design

**Access:**
- Local: `http://localhost:8000/`
- Network: `http://192.168.1.100:8000/` (replace with your actual IP)

### GET /images/{filename}
Serves individual image files directly for viewing or downloading.

**Example:**
```bash
# Direct image access
http://localhost:8000/images/2025-08-26_22-21-22.png
```
...
└── images/               # Created automatically for storing snapshots
    ├── 2025-08-26_22-21-22.png
    ├── 2025-08-26_22-22-22.png
    └── ...
```
